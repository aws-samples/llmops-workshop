...
def build_and_push_docker_image(repository_name, dockerfile='Dockerfile', context='.', build_args={}):
    ...
    _build_from_dockerfile(repository_name, dockerfile, context, build_args)
    ecr_tag = push(repository_name)
    return ecr_tag


def _build_from_dockerfile(repository_name, dockerfile='Dockerfile', context=".", build_args={}):
    
    build_cmd = ['docker', 'build', '-t', repository_name, '-f', dockerfile, context]
